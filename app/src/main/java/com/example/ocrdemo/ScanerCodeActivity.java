...
import com.example.ocrdemo.utils.CaptureActivityHandler;
...
//                imagePicker.setSelectLimit(9);    //图片数量
            imagePicker.setShowCamera(true);  //显示拍照按钮
            imagePicker.setCrop(false);       //不进行裁剪
            Intent intent = new Intent(ScanerCodeActivity.this, ImageGridActivity.class);
                ...
                if (data != null) {
                    ...
                    if (imageItems != null && imageItems.size() > 0) {
                        ...
                        if (rawResult != null) {
                            ...
                            showToast(ScanerCodeActivity.this, "图片识别失败");
                        }
                    } else {
                        showToast(ScanerCodeActivity.this, "没有选择图片");
                    }
                } else {
                    showToast(ScanerCodeActivity.this, "没有选择图片");
                }
...
//        }
    ...
    private void initDialogResult(Result result) {
        ...
        if (BarcodeFormat.QR_CODE.equals(codeType)) {
            final ProgressDialog progress = new ProgressDialog(ScanerCodeActivity.this);
            ...
            Intent intent = new Intent(ScanerCodeActivity.this, ShowScanResultActivity.class);
            intent.putExtra("URL", realContent);
